	...
	class CaptureThread extends Thread{
		public void run(){
			...
			if(aifcBtn.isSelected()){
				...
				//VER COMO FAZER PRA GRAVAR EM PASTA CERTINHOOOOO!
				String caminho = "C://pdi//Pacote"+contador+"//";
				File pasta = new File (caminho);
				pasta.mkdir();
				audioFile = new File(caminho+"Som"+contador+".au");
			...
			try{
				...
				try {
					//ImageClient.converteMusicaParaImagem("C://pdi//");
					//ImageClient.converteImagemParaMusica("C://pdi//");
					contador++;
				} catch (Exception e) {
					e.printStackTrace();
				}
